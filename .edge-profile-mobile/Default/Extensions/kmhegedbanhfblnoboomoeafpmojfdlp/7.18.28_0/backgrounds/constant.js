const MESSAGE_NAME = {
  ...
  POST_QUICK_ANSWER: 'POST_QUICK_ANSWER',
  POST_ADS_LOAD: 'POST_ADS_LOAD',
  ...
  GET_USER_ME_PERSONAL_TIER: 'GET_USER_ME_PERSONAL_TIER',
  GET_PERSONAL_SUBSCRIPTION_STATUS: 'GET_PERSONAL_SUBSCRIPTION_STATUS',
  ...
  POST_SUMMARIZE_STREAM: 'POST_SUMMARIZE_STREAM',
  ...
  GET_COPILOT_LEFT_COUNT: 'GET_COPILOT_LEFT_COUNT',
  DECREMENT_COPILOT_LEFT_COUNT: 'DECREMENT_COPILOT_LEFT_COUNT',
  GET_TEAMS: 'GET_TEAMS',
  POST_SEARCH_BY_URL: 'POST_SEARCH_BY_URL',
  POST_SOURCE_COLLECTION_ATTACHMENT_BULK_SAVE_CREATE:
    'POST_SOURCE_COLLECTION_ATTACHMENT_BULK_SAVE_CREATE',
  POST_SOURCE_COLLECTION_CREATE: 'POST_SOURCE_COLLECTION_CREATE',
  GET_RECENT_WORKSPACE_ID: 'GET_RECENT_WORKSPACE_ID',
  UPDATE_RECENT_WORKSPACE_ID: 'UPDATE_RECENT_WORKSPACE_ID',
  GET_SOURCE_COLLECTIONS_ATTACHMENTS_DETAIL: 'GET_SOURCE_COLLECTIONS_ATTACHMENTS_DETAIL',
};
